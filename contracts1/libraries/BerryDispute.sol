...
/**
* @title Berry Dispute
* @dev Contais the methods related to disputes. Berry.sol references this library for function's logic.
*/
...
library BerryDispute {
    ...
    */
    function vote(BerryStorage.BerryStorageStruct storage self, uint _disputeId, bool _supportsDispute) public {
        ...
        uint voteWeight = BerryTransfer.balanceOfAt(self,msg.sender,disp.disputeUintVars[keccak256("blockNumber")]);
    ...
    */
    function proposeFork(BerryStorage.BerryStorageStruct storage self, address _propNewBerryAddress) public {
        ...
        require(self.disputeIdByDisputeHash[_hash] == 0);
        BerryTransfer.doTransfer(self, msg.sender,address(this), self.uintVars[keccak256("disputeFee")]);//This is the fork fee
    ...
    */
    function updateDisputeFee(BerryStorage.BerryStorageStruct storage self) public {
