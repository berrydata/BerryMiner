...
/**
* itle Berry Dispute
* @dev Contais the methods related to miners staking and unstaking. Berry.sol 
...
library BerryStake {
    ...
    */
    function newStake(BerryStorage.BerryStorageStruct storage self, address staker) internal {
        require(BerryTransfer.balanceOf(self,staker) >= self.uintVars[keccak256("stakeAmount")]);
