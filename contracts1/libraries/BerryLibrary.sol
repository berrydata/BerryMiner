...
library BerryLibrary{
    ...
    */
    function transferOwnership(BerryStorage.BerryStorageStruct storage self,address payable _newOwner) internal {
    ...
    */
    function updateOnDeck(BerryStorage.BerryStorageStruct storage self,uint _requestId, uint _tip) internal {
        BerryStorage.Request storage _request = self.requestDetails[_requestId];
        uint onDeckRequestId = BerryGettersLibrary.getTopRequestID(self);
