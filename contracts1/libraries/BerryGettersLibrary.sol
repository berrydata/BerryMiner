...
library BerryGettersLibrary{
    ...
    */
    function didMine(BerryStorage.BerryStorageStruct storage self, bytes32 _challenge,address _miner) internal view returns(bool){
    ...
    */
    function didVote(BerryStorage.BerryStorageStruct storage self,uint _disputeId, address _address) internal view returns(bool){
    ...
    */
    function getAddressVars(BerryStorage.BerryStorageStruct storage self, bytes32 _data) view internal returns(address){
    ...
    */
    function getAllDisputeVars(BerryStorage.BerryStorageStruct storage self,uint _disputeId) internal view returns(bytes32, bool, bool, bool, address, address, address,uint[9] memory, int){
    ...
    */
    function getDisputeIdByDisputeHash(BerryStorage.BerryStorageStruct storage self,bytes32 _hash) internal view returns(uint){
    ...
    */
    function getDisputeUintVars(BerryStorage.BerryStorageStruct storage self,uint _disputeId,bytes32 _data) internal view returns(uint){
    ...
    */
    function getLastNewValue(BerryStorage.BerryStorageStruct storage self) internal view returns(uint,bool){
    ...
    */
    function getLastNewValueById(BerryStorage.BerryStorageStruct storage self,uint _requestId) internal view returns(uint,bool){
    ...
    */
    function getMinedBlockNum(BerryStorage.BerryStorageStruct storage self,uint _requestId, uint _timestamp) internal view returns(uint){
    ...
    */
    function getMinersByRequestIdAndTimestamp(BerryStorage.BerryStorageStruct storage self, uint _requestId, uint _timestamp) internal view returns(address[5] memory){
    ...
    */
    function getNewValueCountbyRequestId(BerryStorage.BerryStorageStruct storage self, uint _requestId) internal view returns(uint){
    ...
    */
    function getRequestIdByRequestQIndex(BerryStorage.BerryStorageStruct storage self, uint _index) internal view returns(uint){
        require(_index <= 50);
    ...
    * @return uint of reqeuestId
    */
    function getRequestIdByTimestamp(BerryStorage.BerryStorageStruct storage self, uint _timestamp) internal view returns(uint){    
    ...
    */
    function getRequestIdByQueryHash(BerryStorage.BerryStorageStruct storage self, bytes32 _queryHash) internal view returns(uint){    
    ...
    */
    function getRequestQ(BerryStorage.BerryStorageStruct storage self) view internal returns(uint[51] memory){
    ...
    */
    function getRequestUintVars(BerryStorage.BerryStorageStruct storage self,uint _requestId,bytes32 _data) internal view returns(uint){
    ...
    */
    function getRequestVars(BerryStorage.BerryStorageStruct storage self,uint _requestId) internal view returns(string memory,string memory, bytes32,uint, uint, uint) {
        BerryStorage.Request storage _request = self.requestDetails[_requestId]; 
    ...
    */
    function getStakerInfo(BerryStorage.BerryStorageStruct storage self,address _staker) internal view returns(uint,uint){
    ...
    */
    function getSubmissionsByTimestamp(BerryStorage.BerryStorageStruct storage self, uint _requestId, uint _timestamp) internal view returns(uint[5] memory){
    ...
    */
    function getTimestampbyRequestIDandIndex(BerryStorage.BerryStorageStruct storage self,uint _requestID, uint _index) internal view returns(uint){
    ...
    */ 
    function getUintVar(BerryStorage.BerryStorageStruct storage self,bytes32 _data) view internal returns(uint){
    ...
    */
    function getVariablesOnDeck(BerryStorage.BerryStorageStruct storage self) internal view returns(uint, uint,string memory){ 
    ...
    */
    function getTopRequestID(BerryStorage.BerryStorageStruct storage self) internal view returns(uint _requestId){
            uint _max;
            uint _index;
    ...
    */
    function isInDispute(BerryStorage.BerryStorageStruct storage self, uint _requestId, uint _timestamp) internal view returns(bool){
    ...
    */
    function retrieveData(BerryStorage.BerryStorageStruct storage self, uint _requestId, uint _timestamp) internal view returns (uint) {
    ...
    */
    function totalSupply(BerryStorage.BerryStorageStruct storage self) internal view returns (uint) {
