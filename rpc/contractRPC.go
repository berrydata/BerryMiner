...
import (
	...
	berry2 "github.com/berrydata/BerryMiner/contracts2"
...
type contractWrapper struct {
	...
	contract3 	*berry2.BerryTransactor
...
func PrepareContractTxn(ctx context.Context,proxy db.DataServerProxy, ctxName string, callback berryCommon.TransactionGeneratorFN) error {
	...
	for i < 5 {
		...
		instance3 := ctx.Value(berryCommon.NewTransactorContractContextKey).(*berry2.BerryTransactor)
